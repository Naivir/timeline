...
**Tests**: Test tasks are MANDATORY. For each user story, tests MUST be authored
and executed before implementation tasks, must fail first, and must pass before
...
- [ ] T002 Install and verify [language]/[framework] dependencies required to run tests
- [ ] T003 [P] Configure linting and formatting tools
- [ ] T004 Define verification commands and evidence capture approach for this feature
...
- [ ] TXXX [P] Browser-based live backend verification test (required for frontend/backend features)
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Run required verification commands for changed scripts/templates and capture evidence
...
- Story tests MUST pass before story is marked complete
...
- Verify tests fail before implementing and pass before completion
